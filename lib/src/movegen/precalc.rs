...
impl Precalc {
    pub fn bishop_attack(&self, square: impl BitBoardIdx, occ: BitBoard) -> BitBoard {
        ...
        let occ = occ.0.wrapping_mul(BISHOP_MAGIC[square.idx_usize()] as u64);
    ...
    pub fn rook_attack(&self, square: impl BitBoardIdx, occ: BitBoard) -> BitBoard {
        ...
        let occ = occ.0.wrapping_mul(ROOK_MAGIC[square.idx_usize()] as u64);
...
pub fn calc_bishop_magic() -> Box<[[BitBoard; 512]; 64]> {
    ...
    for square in 0..64 {
        ...
        for idx in 0..max_idx {
            ...
            let magic_idx =
                occ.0.wrapping_mul(BISHOP_MAGIC[square as usize] as u64) >> (64 - attack_bits);
...
pub fn calc_rook_magic() -> Box<[[BitBoard; 4096]; 64]> {
    ...
    for square in 0..64 {
        ...
        for idx in 0..max_idx {
            let occ = occupancy(idx, attack_mask);
            let magic_idx =
                occ.0.wrapping_mul(ROOK_MAGIC[square as usize] as u64) >> (64 - attack_bits);
